/**
  ...
  * @brief Instrucciones de E/S: READ (cinta→registro) y WRITE (registro→cinta).
  * @date Feb 21 2026
  * @version 1.0
  */

#ifndef PRACTICARAM_INCLUDE_INSTRUCCION_IO_H
#define PRACTICARAM_INCLUDE_INSTRUCCION_IO_H
