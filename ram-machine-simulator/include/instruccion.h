/**
  ...
  * @brief Interfaz base para todas las instrucciones RAM (patrón Strategy).
  * @date Feb 20 2026
  * @version 1.0
  */
...
class Instruccion {
 public:
  ...
  virtual void execute(MemoriaDatos& datos, InputUnit& entrada, OutputUnit& salida, size_t& pc, bool& halt_flag) = 0;
};
