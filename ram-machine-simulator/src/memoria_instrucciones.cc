 ...
 * @param instruccion 
 */
void MemoriaInstrucciones::AgregarInstruccion(std::unique_ptr<Instruccion> instruccion) {
 ...
 * @return Instruccion* 
 */
Instruccion* MemoriaInstrucciones::ObtenerInstruccion(size_t pc) const {
